...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ animacaodoscroll)\n/* harmony export */ });\nfunction animacaodoscroll() {\n  var sections = document.querySelectorAll('[data-anime=\"scroll\"]');\n  var telasessentaporc = window.innerHeight * 0.6;\n  function animaraoscroll() {\n    sections.forEach(function (section) {\n      var sectiontopo = section.getBoundingClientRect().top;\n      var sectionnotopocomp = sectiontopo - telasessentaporc < 0;\n      if (sectionnotopocomp) {\n        section.classList.add('ativo');\n      } else if (section.classList.contains('ativo')) {\n        section.classList.remove('ativo');\n      }\n    });\n  }\n  if (sections.length) {\n    animaraoscroll();\n    window.addEventListener('scroll', animaraoscroll);\n  }\n}\n\n//# sourceURL=webpack://animais-do-polo-norte/./js/modules/scroll-animacao.js?");
